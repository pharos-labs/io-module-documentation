...
Set the *IP Address* and *Port* to that configured for the HTTPS interface on the Express Controller.\
...
<table>
    ...
    <tr>
        ...
        <td>Remote Controller's type, i.e. 'Express Control'</td>
    </tr>
    <tr>
